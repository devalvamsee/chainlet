...
- completely remove (rollback) and be replaced by the circuit breaker
  (PR to rollback: https://github.com/devalvamsee/chainlet/pull/795 and https://github.com/crypto-org-chain/gravity-bridge/pull/96)
...
- https://github.com/devalvamsee/chainlet/pull/795
