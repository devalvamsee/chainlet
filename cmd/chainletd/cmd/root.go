...
import (
	...
	memiavlcfg "github.com/devalvamsee/chainlet/store/config"
	...
	e2eecli "github.com/devalvamsee/chainlet/x/e2ee/client/cli"
...
func addModuleInitFlags(startCmd *cobra.Command) {
	...
	chainlet.AddModuleInitFlags(startCmd)
...
func appExport(
	...
	var chainletApp *app.App
	if height != -1 {
		chainletApp = app.New(logger, db, traceStore, false, appOpts)

		if err := chainletApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		chainletApp = app.New(logger, db, traceStore, true, appOpts)
	}

	return chainletApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs, modulesToExport)
}
