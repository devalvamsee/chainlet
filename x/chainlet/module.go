...
import (
	...
	"github.com/devalvamsee/chainlet/x/chainlet/keeper"
	"github.com/devalvamsee/chainlet/x/chainlet/simulation"
...
// RegisterStoreDecoder registers a decoder for chainlet module's types
func (am AppModule) RegisterStoreDecoder(sdr simtypes.StoreDecoderRegistry) {
	sdr[types.StoreKey] = simulation.NewDecodeStore()
}

// GenerateGenesisState creates a randomized GenState of the chainlet module.
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	simulation.RandomizedGenState(simState)
}

// WeightedOperations returns the all the chainlet module operations with their respective weights.
