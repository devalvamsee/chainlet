...
import (
	...
	ica "github.com/devalvamsee/chainlet/x/chainlet/events/bindings/cosmos/precompile/ica"
	relayer "github.com/devalvamsee/chainlet/x/chainlet/events/bindings/cosmos/precompile/relayer"
	chainleteventstypes "github.com/devalvamsee/chainlet/x/chainlet/events/types"
...
var (
	...
	RelayerValueDecoders = ValueDecoders{
		...
		chainleteventstypes.AttributeKeySrcPortInfo:    ReturnStringAsIs,
		channeltypes.AttributeKeySrcChannel:          ReturnStringAsIs,
		chainleteventstypes.AttributeKeySrcChannelInfo: ReturnStringAsIs,
	...
	IcaValueDecoders = ValueDecoders{
		chainleteventstypes.AttributeKeySeq:   ConvertUint64,
		channeltypes.AttributeKeySrcChannel: ReturnStringAsIs,
	}
)
...
func RelayerConvertEvent(event sdk.Event) (*ethtypes.Log, error) {
	...
	replaceAttrs := map[string]string{
		chainleteventstypes.AttributeKeySrcPortInfo:    channeltypes.AttributeKeySrcPort,
		chainleteventstypes.AttributeKeySrcChannelInfo: channeltypes.AttributeKeySrcChannel,
	}
