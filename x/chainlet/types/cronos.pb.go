...
// source: chainlet/chainlet.proto
...
type TokenMappingChangeProposal struct {
	...
	// only when updating chainlet (source) tokens
...
func init() {
	proto.RegisterType((*Params)(nil), "chainlet.Params")
	proto.RegisterType((*TokenMappingChangeProposal)(nil), "chainlet.TokenMappingChangeProposal")
	proto.RegisterType((*TokenMapping)(nil), "chainlet.TokenMapping")
}

func init() { proto.RegisterFile("chainlet/chainlet.proto", fileDescriptor_8bc54992a93db2d2) }
