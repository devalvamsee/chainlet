...
// GetAuthority returns the x/chainlet module's authority.
...
func (k Keeper) onPacketResult(
	...
	data, err := chainletprecompiles.OnPacketResultCallback(packet.SourceChannel, packet.Sequence, acknowledgement)
	if err != nil {
		return err
	}
