...
func NewSendToIbcHandler(bankKeeper types.BankKeeper, chainletKeeper chainletkeeper.Keeper) *SendToIbcHandler {
...
func (h SendToIbcHandler) handle(
	...
	if err = h.chainletKeeper.IbcTransferCoins(ctx, sender.String(), recipient, coins, channelId); err != nil {
		return err
	}
	return nil
}
