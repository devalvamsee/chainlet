...
func (suite *KeeperTestSuite) RegisterSourceToken(
	...
	denom := "chainlet" + contractAddress
...
func (suite *KeeperTestSuite) TestRegisterOrUpdateTokenMapping() {
	...
	testCases := []struct {
		...
		},
		{
			...
			types.MsgUpdateTokenMapping{
				Sender:   "",
				Denom:    "chainlet0xf6d4fecb1a6fb7c2ca350169a050d483bd87b88@",
				Contract: contractAddress,
				Symbol:   "",
				Decimal:  0,
			},
		...
		},
		{
			...
			types.MsgUpdateTokenMapping{
				Sender:   "",
				Denom:    "chainlet0xF6D4FeCB1a6fb7C2CA350169A050D483bd87b883",
				Contract: contractAddress,
				Symbol:   "",
				Decimal:  0,
			},
