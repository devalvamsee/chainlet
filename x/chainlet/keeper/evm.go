...
func (k Keeper) ConvertCoinFromNativeToCRC21(ctx sdk.Context, sender common.Address, coin sdk.Coin, autoDeploy bool) error {
	...
	if isSource {
		...
		// unlock crc tokens
		_, err = k.CallModuleCRC21(ctx, contract, "transfer_from_chainlet_module", sender, coin.Amount.BigInt())
		if err != nil {
			return err
		}
	} else {
		...
		// mint crc tokens
		_, err = k.CallModuleCRC21(ctx, contract, "mint_by_chainlet_module", sender, coin.Amount.BigInt())
		if err != nil {
			return err
		}
	}
...
func (k Keeper) ConvertCoinFromCRC21ToNative(ctx sdk.Context, contract, receiver common.Address, amount sdkmath.Int) error {
	...
	if isSource {
		_, err := k.CallModuleCRC21(ctx, contract, "transfer_by_chainlet_module", receiver, amount.BigInt())
		if err != nil {
			return err
		}
		...
		_, err = k.CallModuleCRC21(ctx, contract, "burn_by_chainlet_module", receiver, amount.BigInt())
		if err != nil {
			return err
		}
	}
