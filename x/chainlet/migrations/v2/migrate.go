...
import (
	"github.com/devalvamsee/chainlet/x/chainlet/exported"
...
// Migrate migrates the x/chainlet module state from the consensus version 1 to
// version 2. Specifically, it takes the parameters that are currently stored
// and managed by the x/params modules and stores them directly into the x/chainlet
// module state.
